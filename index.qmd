...
dreamy_mean_obs = dreamy_obs['post_surgical_score'].mean()
duck_mean_obs   = duck_obs['post_surgical_score'].mean()

fig, ax = plt.subplots(figsize=(8, 5))

ax.scatter(dreamy_obs['patient'], dreamy_obs['post_surgical_score'],
           color=DREAMY_COLOR, marker='o', s=60, alpha=0.75, label='Doc Dreamy', zorder=3)
ax.scatter(duck_obs['patient'], duck_obs['post_surgical_score'],
           color=DUCK_COLOR, marker='^', s=60, alpha=0.75, label='Doc Duck', zorder=3)

ax.axhline(dreamy_mean_obs, color=DREAMY_COLOR, linewidth=1.8, linestyle='--', zorder=2)
ax.axhline(duck_mean_obs,   color=DUCK_COLOR,   linewidth=1.8, linestyle='--', zorder=2)

x_max = patients_df['patient'].max()
ax.text(x_max + 1, dreamy_mean_obs, f'○ Mean = {dreamy_mean_obs:.2f}',
        color=DREAMY_COLOR, fontsize=10, va='center')
ax.text(x_max + 1, duck_mean_obs,   f'△ Mean = {duck_mean_obs:.2f}',
        color=DUCK_COLOR,   fontsize=10, va='center')
...
ax.set_xlim(0, x_max + 14)
ax.grid(True, alpha=0.3, linestyle=':')
ax.spines[['top', 'right']].set_visible(False)
ax.legend(fontsize=10)

fig.tight_layout()
fig.savefig('figure1_observational.png', dpi=150, bbox_inches='tight')
plt.show()
```
...
dreamy_rnd      = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Dreamy']
duck_rnd        = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Duck']
dreamy_mean_rnd = dreamy_rnd['post_surgical_score'].mean()
duck_mean_rnd   = duck_rnd['post_surgical_score'].mean()

fig, ax = plt.subplots(figsize=(8, 5))

ax.scatter(dreamy_rnd['patient'], dreamy_rnd['post_surgical_score'],
           color=DREAMY_COLOR, marker='o', s=60, alpha=0.75, label='Doc Dreamy', zorder=3)
ax.scatter(duck_rnd['patient'], duck_rnd['post_surgical_score'],
           color=DUCK_COLOR, marker='^', s=60, alpha=0.75, label='Doc Duck', zorder=3)

ax.axhline(dreamy_mean_rnd, color=DREAMY_COLOR, linewidth=1.8, linestyle='--', zorder=2)
ax.axhline(duck_mean_rnd,   color=DUCK_COLOR,   linewidth=1.8, linestyle='--', zorder=2)

x_max = patients_randomized_df['patient'].max()
ax.text(x_max + 1, dreamy_mean_rnd, f'○ Mean = {dreamy_mean_rnd:.2f}',
        color=DREAMY_COLOR, fontsize=10, va='center')
ax.text(x_max + 1, duck_mean_rnd,   f'△ Mean = {duck_mean_rnd:.2f}',
        color=DUCK_COLOR,   fontsize=10, va='center')
...
fig.tight_layout()
fig.savefig('figure2_randomized.png', dpi=150, bbox_inches='tight')
plt.show()
...
ax.scatter(dreamy_obs['severity'], dreamy_obs['post_surgical_score'],
           color=DREAMY_COLOR, marker='o', s=60, alpha=0.75, label='Doc Dreamy', zorder=3)
ax.scatter(duck_obs['severity'], duck_obs['post_surgical_score'],
           color=DUCK_COLOR, marker='^', s=60, alpha=0.75, label='Doc Duck', zorder=3)
...
x_right = patients_df['severity'].max() + 0.15
ax.text(x_right, dreamy_mean_obs, f'○ Mean = {dreamy_mean_obs:.2f}',
        color=DREAMY_COLOR, fontsize=10, va='center')
ax.text(x_right, duck_mean_obs,   f'△ Mean = {duck_mean_obs:.2f}',
        color=DUCK_COLOR,   fontsize=10, va='center')


y_top = patients_df['post_surgical_score'].max()
ax.text((SHADE_LO + SHADE_HI) / 2, y_top * 0.97, 'Overlap\nRegion',
...
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=12)
ax.set_xlim(patients_df['severity'].min() - 0.3,
            patients_df['severity'].max() + 1.2)
ax.grid(True, alpha=0.3, linestyle=':')
ax.spines[['top', 'right']].set_visible(False)
ax.legend(fontsize=10)

fig.tight_layout()
fig.savefig('figure3_stratification.png', dpi=150, bbox_inches='tight')
plt.show()
